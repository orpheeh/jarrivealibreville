...
router.get('/admin/visites', adminController.verifyAdminToken, adminController.visite);

router.get('/admin/vk', adminController.verifyAdminToken, adminController.vk);
