...
router.get('/api/commandes/:id', authController.verifyAccessToken, commandeController.getCommandeById);

router.get('/api/commandes/open/admin', commandeController.getCommandes)
